...
Ported from ``tests/tui/extract_test.go``. The four cases are the Go table, and
the fence semantics are the same ones: a fence is any line whose trimmed form

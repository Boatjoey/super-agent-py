...
Go's ``runtime/api_machine.go`` re-exports the machine's whole vocabulary so the
rest of the program can write ``runtime.Transition``. It must NOT reintroduce the
